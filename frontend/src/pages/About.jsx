...
export default function About() {
  ...
  // 🔥 NEW: scroll trigger ref
  const statsRef = useRef(null)

  // 🔥 NEW: detects scroll in/out
  const isInView = useInView(statsRef, {
    margin: "-100px",
    once: false, // allows up/down re-trigger
  })
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-14 items-center">
        ...
        {/* ============================= */}
        {/* ✅ STATS SECTION (UPDATED ONLY LOGIC) */}
        {/* ============================= */}
        ...
        >
          ...
          <div className="bg-gradient-to-br from-emerald-900 to-emerald-800
            ...
            <h3 className="text-4xl font-bold text-emerald-400 mb-2">
              {isInView ? (
                <CountUp key={isInView} end={5} duration={3} />
              ) : 0}
              +
            </h3>
          ...
          <div className="bg-gradient-to-br from-emerald-900 to-emerald-800
            ...
            <h3 className="text-4xl font-bold text-emerald-400 mb-2">
              {isInView ? (
                <CountUp key={isInView} end={50} duration={3} />
              ) : 0}
              +
            </h3>
          ...
          <div className="bg-gradient-to-br from-emerald-900 to-emerald-800
            ...
            <h3 className="text-4xl font-bold text-emerald-400 mb-2">
              {isInView ? (
                <CountUp key={isInView} end={100} duration={3} />
              ) : 0}
              +
            </h3>
          ...
          <div className="bg-gradient-to-br from-emerald-900 to-emerald-800
            ...
            <h3 className="text-4xl font-bold text-emerald-400 mb-2">
              {isInView ? (
                <CountUp key={isInView} end={25} duration={3} />
              ) : 0}
              +
            </h3>
        ...
        >
          ...
          {/* Skills Cards (UNCHANGED) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-20">
            <motion.div whileHover={{ y: -5 }} className="bg-zinc-800 rounded-xl p-6 border border-emerald-500/30 shadow-[0_0_30px_rgba(16,185,129,0.15)] hover:shadow-[0_0_45px_rgba(16,185,129,0.3)] hover:scale-105 transition-all duration-500">
              <FaRobot className="text-blue-400 text-2xl mb-3" />
              <h4 className="font-bold text-xl mb-2 text-white">Robotics & Automation</h4>
              <p className="text-zinc-400 text-sm">Autonomous robots using ROS, motion planning, sensor fusion, and AI perception systems.</p>
            </motion.div>

            <motion.div whileHover={{ y: -5 }} className="bg-zinc-800 rounded-xl p-6 border border-emerald-500/30 shadow-[0_0_30px_rgba(16,185,129,0.15)] hover:shadow-[0_0_45px_rgba(16,185,129,0.3)] hover:scale-105 transition-all duration-500">
              <FaMicrochip className="text-blue-400 text-2xl mb-3" />
              <h4 className="font-bold text-xl mb-2 text-white">IoT & PCB Design</h4>
              <p className="text-zinc-400 text-sm">Smart IoT systems and optimized multi-layer PCB designs with signal integrity and power management.</p>
            </motion.div>

            <motion.div whileHover={{ y: -5 }} className="bg-zinc-800 rounded-xl p-6 border border-emerald-500/30 shadow-[0_0_30px_rgba(16,185,129,0.15)] hover:shadow-[0_0_45px_rgba(16,185,129,0.3)] hover:scale-105 transition-all duration-500">
              <FaBrain className="text-blue-400 text-2xl mb-3" />
              <h4 className="font-bold text-xl mb-2 text-white">ML & Deep Learning</h4>
              <p className="text-zinc-400 text-sm">CNNs, NLP, Computer Vision and predictive analytics using TensorFlow & PyTorch.</p>
            </motion.div>

            <motion.div whileHover={{ y: -5 }} className="bg-zinc-800 rounded-xl p-6 border border-emerald-500/30 shadow-[0_0_30px_rgba(16,185,129,0.15)] hover:shadow-[0_0_45px_rgba(16,185,129,0.3)] hover:scale-105 transition-all duration-500">
              <FaShieldAlt className="text-blue-400 text-2xl mb-3" />
              <h4 className="font-bold text-xl mb-2 text-white">Cybersecurity</h4>
              <p className="text-zinc-400 text-sm">Threat detection, malware analysis, and AI-powered cybersecurity systems.</p>
            </motion.div>
          </div>
